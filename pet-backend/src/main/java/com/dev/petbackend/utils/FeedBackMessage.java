...
public class FeedBackMessage {
    ...
    public static final String DELETE_SUCCESS = "Deleted Resource successfully";
    ...
    public static final String CANNOT_REVIEW = "Veterinarian can not review themselves";
